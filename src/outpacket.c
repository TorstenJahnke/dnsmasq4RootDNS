...
void end_opt6(int container)
{
   ...
   u16 len = (outpacket_counter > (size_t)(container + 4)) ? (u16)(outpacket_counter - container - 4) : 0;
...
{
  int ret = (outpacket_counter > (size_t)INT_MAX) ? INT_MAX : (int)outpacket_counter;
